...
## 必要因素：
1.魔法师智商 <mark style="background-color:blue;">IQ</mark>。此项过低可能会出现类似于no such file or directory、no module named deepdanbooru，python is not an executable file等未知错误，一般来说，IQ越高，出现问题无法解决的可能性越低
